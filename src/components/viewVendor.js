...
const ViewVendor = ({ match, user }) => {
  ...
  const toggleSavedAlert = () => {
    const save = document.querySelector(".saving");
  ...
  return (
    <div className="bg-light-skin min-h-full min-h-screen pt-10 m-auto">
      <div className="pt-8 pformWrapper">
        ...
        <div
          className={`bg-orange-200 md:flex px-4 py-2 justify-around sm:max-w-lg lg:max-w-2xl m-auto ${
        ...
        >
          <div className="flex">
            <a
              ...
              href={`http://wa.me/${profile.phone_number}`}
              className="hover:no-underline text-black font-semibold relative mr-2"
            >
              book this vendor
            </a>
            <a href={`http://wa.me/${profile.phone_number}`}>
              <svg
                fill="#ffffff"
          ...
          <div>
            <button onClick={() => saveAven()} className="outline-none">
              Save this vendor
            </button>
          </div>
        </div>
